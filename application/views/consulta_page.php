...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="http://localhost/CitasMedicas_Cuenca/" class="selected">
                <div class="option">
            ...
            <a href="http://localhost/CitasMedicas_Cuenca/consultas">
                <div class="option">
            ...
            <a href="http://localhost/CitasMedicas_Cuenca/medico">
                <div class="option">
            ...
            <a href="http://localhost/CitasMedicas_Cuenca/empleado">
                <div class="option">
            ...
            <a href="http://localhost/CitasMedicas_Cuenca/especialidad">
                <div class="option">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="<?php echo 'filaC_'.$consulta->cod_con; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a role='button' class='btn btn-danger' href='http://localhost/CitasMedicas_Cuenca/CM/eliminarConsulta?cod_con=<?php echo $consulta->cod_con; ?>'><i class='fas fa-trash-alt'></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                                }
